      ...
      <div className="contact-container">
        <div className="contact-info">
          ...
          <div className="contact-details">
            ...
            <div className="contact-detail">
              <div className="detail-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.56 2 2 0 0 1 3.6 1.36h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9a16 16 0 0 0 6 6l.92-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 17z"/></svg>
              </div>
              <div>
        ...
        <div className="contact-form-card">
          ...
          <div className="form-row-2">
            <FormField label="Correo electrónico" name="email"  type="email" placeholder="correo@ejemplo.com" />
            <FormField label="Nombre"             name="nombre"              placeholder="Tu nombre"          />
          </div>
          <FormField label="Mensaje">
            <textarea name="mensaje" placeholder="¿En qué podemos ayudarte?" rows={5} />
          </FormField>
